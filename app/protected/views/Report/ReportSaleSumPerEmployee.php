...
<div class="panel panel-primary" style="margin: 10px">
    ...
    <div class="panel-body">
        ...
        <div>
            ...
            <label style="width: 80px">ถึง</label>
        ...
        <?php if ($_POST) : ?>
            ...
            if (count($result) != 0) {
                ...
                foreach ($result as $value) {
                    $arr_value[$value['user_id']] = $value['MONEY'];
                }

                foreach ($result as $value) {
                    $arr_main[$value['user_id']] = 0;
                }
            ...
            <div class="panel_body">
                ...
                <table border="1" width="700px" style="margin: auto; margin-top: 10px;">
                    <tr style="background-color: #eee;">
                        <td colspan="3" style="text-align: center; padding: 15px;">
                            <span style="font-size: 18px; color: #555;">สรุปยอดขายตามพนักงาน ตั้งแต่วันที่ : 
