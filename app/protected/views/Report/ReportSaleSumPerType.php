...
<div class="panel panel-primary" style="margin: 10px">
    ...
    <div class="panel-body">
        ...
        <div>
            ...
            <input type="text" name="date_start" class="form-control" style="width: 200px" value="<?php
			        if ($_POST) {
			            echo $_POST['date_start'];
			        }
			        ?>" />
            <label>ถึง</label>
            <input type="text" name="date_end" class="form-control" style="width: 200px" value="<?php
                   if ($_POST) {
                       echo $_POST['date_end'];
                   }
						?>" />
        ...
        <?php if ($_POST) : ?>
            ...
            if (count($result) != 0) {
                ...
                // loop product_name
                $data_name = CHtml::listData(GroupProduct::model()->findAll(), "group_product_id", "group_product_name");

                foreach ($data_name as $valName) {
                    $resultName[] = $valName;
                }
                ...
                foreach ($result as $value) {
                    $arr_value[$value['group_product_id']] = $value['money'];
                }

                foreach ($data_name as $keys => $value) {
                    $arr_main[$keys] = 0;
                }
            ...
            <div class="panel-body">
                ...
                <table border="1" width="800px" style="margin: auto; margin-top: 10px;">
                    <tr style="background-color: #eee;">
                        <td colspan="3" style="text-align: left; padding: 15px;">
                            <span style="font-size: 18px; color: #555;">สรุปยอดขายตามประเภท ตั้งแต่วันที่ : 
                    ...
                    foreach ($result as $value) :
                        ...
                        <tr style="background-color: #fafafa;">
                            ...
                            <td style="text-align: left;">
                                <span><?php echo $value['group_product_name']; ?></span>
                            </td>
                    ...
                    <tr>
                        ...
                        <td style="text-align: right; background-color: #ffffcc;">
                            <?php echo number_format($result_sum, 2); ?>
                        </td>
                    </tr>
                </table>
            </div>
