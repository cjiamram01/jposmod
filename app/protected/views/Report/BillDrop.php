...
// header
$header = "
    <div class='header-text bold'>ใบวางบิล</div>
    <div class='header-text'>[LOGO] {$org->org_name} {$org->org_name_eng}</div>
...
foreach ($billSales as $r) {
    ...
    $content .= "
        <tr>
            ...
            <td class='cell' style='text-align: right' width='50px'>$bill_sale_id</td>
            <td class='cell' style='text-align: right' width='50px'>$label_price</td>
        </tr>";
    $i++;
}
