    ...
    <div class="panel-body">
        ...
        <table>
            <tr>
                ...
                <td>
                    <div class="input-append">
                        ...
                        <input type="text" name="user_name" value="<?php echo @$repair->user->user_name; ?>" disabled class="disabled form-control" style="width: 250px" />
                ...
                <td><input type="text" name="repair_created_date" class="form-control" value="<?php echo Util::nowThai(); ?>" /></td>
            ...
            <tr>
                ...
                <td>
                    <span class="alert alert-danger" style="clear: both; display: inline-block;">
