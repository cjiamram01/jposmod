...
<div class="col-sm-1">
       <a href="#" class="btn btn-primary" onclick="document.getElementById('formSD').submit();">
          ...
          <tbody>
            <?php
              ...
              if(isset($id))
              {
                ...
                ->select("sd.id,tp.product_name,sd.qty,sd.price,tp.product_code")
                ->from('tbl_shipingdetail sd')
                ->join('tb_product tp','sd.Item_id=tp.product_id')
                ->where('sd.Shiping_id=:id',array(':id'=>$id))
                ->queryAll(); 
                 $i=1;
                ...
                foreach($details as $d)
                {
                  ...
                  echo "<td>
                    <a href='".$strPath."/basic/ShipingDetailDelete/".$id."?pid=".$d["id"]."'
